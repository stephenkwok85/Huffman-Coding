...
public class HuffmanCoding {
    ...
    public void makeSortedList() {
        ...
        for(int i=0; i<fq.length; i++){
            if(fq[i]>0){
                sortedCharFreqList.add(new CharFreq((char) i, (double)fq[i]/count));
            }
        }

        if(sortedCharFreqList.size()==1){
            char temp = (char) ((sortedCharFreqList.get(0).getCharacter() + 1) % 128);
	...
	/* Your code goes here */
        ...
        for (CharFreq c : sortedCharFreqList) {
            TreeNode t = new TreeNode(c, null, null);
            source.enqueue(t);
        }
        ...
        while(source.size()>0 || target.size()!=1){
            ...
            else{ //source = target or source < target
	...
	/* Your code goes here */
        ...
        makeEncodings2(huffmanRoot, "");
    }

    //recursive method for makeEncodings
    private void makeEncodings2(TreeNode parent, String encoding){
        if(parent.getLeft()==null && parent.getRight()==null){
            encodings[(int) parent.getData().getCharacter()] = encoding;
        }
        else{
            makeEncodings2(parent.getLeft(), encoding + "0");
            makeEncodings2(parent.getRight(), encoding + "1");
        }
    }
